        ...
        <ul class="box">
            <li>
                <div class="wrapper">
                    ...
                    <span  class="item-msg">{{params.discountPrice}}</span>
                    <span  class="item-msg">%折</span>
                </div>
            </li>
            <li>
                <div class="wrapper">
                    <span class="item-name">应收金额</span>
                    <span  class="item-msg">{{params.receivableAmount}}</span>
...
export default {
    ...
    methods:{
        again(){
            this.$router.push({path:'sellGoods'})
        },
        touchStart(event){
            try{
        ...
        backEdit(){
            this.$router.push({name:'SellGoods'})
        },
    },
}
</script>
